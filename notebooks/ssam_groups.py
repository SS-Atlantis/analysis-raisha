...
conditions = {
    '2019-01-14':'low Fraser flow neap tide winter', '2019-01-20':'low Fraser flow spring tide winter',
    '2020-01-16':'high Fraser flow neap tide winter', '2020-01-11':'high Fraser flow spring tide winter', 
    '2020-01-24':'high Fraser flow spring tide winter',
    '2019-01-26':'low Fraser flow neap tide winter', '2019-01-21':'low Fraser flow spring tide winter',
    '2020-01-03':'high Fraser flow neap tide winter',
    '2019-07-10':'low Fraser flow neap tide summer', '2019-07-16':'low Fraser flow spring tide summer', 
    '2020-07-12':'high Fraser flow neap tide summer', '2020-07-22':'high Fraser flow spring tide summer',
    '2019-07-25':'low Fraser flow neap tide summer', '2019-07-04':'low Fraser flow spring tide summer',
    '2020-07-13':'high Fraser flow neap tide summer', '2020-07-21':'high Fraser flow spring tide summer',
}
...
simulations = { 'low Fraser flow spring tide winter': 1, 'low Fraser flow neap tide winter':2,
                'high Fraser flow spring tide winter':3, 'high Fraser flow neap tide winter':4,
                'low Fraser flow spring tide summer': 1, 'low Fraser flow neap tide summer':2,
                'high Fraser flow spring tide summer':3, 'high Fraser flow neap tide summer':4,}