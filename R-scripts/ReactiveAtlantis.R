...
nc.out.current <- 'output-20yr/outputSalishSea.nc'
nc.out.previous <- 'output-5yr/outputSalishSea.nc'
groups.csv <- '/ocean/rlovindeer/Atlantis/atlantis-trunk/salish-sea-atlantis-model/SS_grps.csv'
bgm.file <- '/ocean/rlovindeer/Atlantis/atlantis-trunk/salish-sea-atlantis-model/SS_ll.bgm'
cum.depths <- c(0, 25, 50, 100, 250, 400, 700)
compare(nc.out.current, nc.out.old = nc.out.previous, grp.csv = groups.csv, bgm.file=bgm.file, cum.depths=cum.depths)

nc.initial <- '/ocean/rlovindeer/Atlantis/atlantis-trunk/salish-sea-atlantis-model/SS_init.nc'
nc.current <- 'output-20yr/outputSalishSea.nc'
grp.csv <- '/ocean/rlovindeer/Atlantis/atlantis-trunk/salish-sea-atlantis-model/SS_grps.csv'
prm.file <- '/ocean/rlovindeer/Atlantis/atlantis-trunk/salish-sea-atlantis-model/02SS_Biology.prm'
